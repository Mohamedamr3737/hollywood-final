...
class DietController {
  ...
  Future<List<dynamic>> fetchDietPlans() async {
    ...
    final url = "${ApiConfig.baseUrl}/api/patient/prescription/diet-list";
  ...
  Future<List<dynamic>> fetchDietDays(int dietId) async {
    final bearerToken = await getAccessToken();
    final url = "${ApiConfig.baseUrl}/api/patient/prescription/diet-days/?diet_id=$dietId";
  ...
  Future<List<dynamic>> fetchDietTimes() async {
    final bearerToken = await getAccessToken();
    final url = "${ApiConfig.baseUrl}/api/patient/prescription/diet-times";
  ...
  Future<List<dynamic>> fetchDietMeals({
    ...
    final bearerToken = await getAccessToken();
    final url = "${ApiConfig.baseUrl}/api/patient/prescription/diet-meals"
